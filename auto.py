...
POST_CLICK_WAIT_TIME_SECONDS = 0.2

# Pixel check configuration
TARGET_PIXEL_COLOR = (254, 254, 254)
PIXEL_CHECK_X = 737
PIXEL_CHECK_Y = 450
COLOR_CHECK_TIMEOUT_SECONDS = 15
COLOR_CHECK_INTERVAL_SECONDS = 0.2
...
MAP_Y_START_VALUE = 400                # NEW: configurable starting Y
